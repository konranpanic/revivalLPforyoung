...
export function Footer() {
  return (
    <footer className="relative border-t border-border/30 bg-background py-16">
      {/* Top Accent Line */}
      ...
      <div className="mx-auto max-w-6xl px-6">
        <div className="flex flex-col items-center gap-8">
          ...
          <div className="text-center">
            ...
            <p className="mt-2 text-[10px] tracking-[0.3em] text-slate-500">
          ...
          <div className="flex flex-wrap justify-center gap-8">
            <a
              ...
              className="text-xs tracking-wider text-slate-500 transition-colors hover:text-primary"
            >
              会社概要
            </a>
            <a
          ...
          {/* Copyright */}
          <p className="font-serif text-xs tracking-wider text-slate-500">
