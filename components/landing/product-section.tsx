...
const thumbnails = [
  { id: 1, label: "正面全体", src: "/products/product-171/1.jpeg" },
  { id: 2, label: "底面・角スレ", src: "/products/product-171/2.jpeg" },
  { id: 3, label: "内側・シリアル", src: "/products/product-171/3.jpeg" },
  { id: 4, label: "金具拡大", src: "/products/product-171/4.jpeg" },
]
